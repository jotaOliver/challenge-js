...
pessoa.nomeCompleto = function(){
    return 'Ola! menu nome é '+ pessoa.nome + ' ' + pessoa.sombrenome + '!'  
}
...
pessoa.apresentacao = function(){
    ...
    return 'Olá, eu sou'+ letra + pessoa.nome + ' ' + pessoa.sombrenome + ', tenho ' + pessoa.idade + ano +', ' + pessoa.altura + 'm, meu peso é ' + pessoa.peso + 'Kg e, so hoje, eu já caminhei ' + pessoa.caminhouQuantosMetros + ' metros !';
}
